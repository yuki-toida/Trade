...
namespace Trade.UI.Web.Controllers
{
    ...
    {
        public CalendarController(IApplicationContext appContext, IOptions<CommonOption> optionsAccessor)
        ...
        public async Task<IActionResult> Index(DateTime? date)
        {
            ...
            // カレンダーイベント取得
            var events = await service.GetCalendarEvents(Option.GoogleCalendarApiKey, date.Value, nextDate.AddDays(-1));
